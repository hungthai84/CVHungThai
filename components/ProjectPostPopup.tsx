                ...
                <div className="project-post-nav-header flex items-center justify-between">
                 ...
                 <div className="project-post-scroll-content no-scrollbar" ref={scrollRef}>
                    ...
                    <main className="project-post-main">
                        <div className="project-post-content-wrapper" style={{ padding: '2.5rem 2.5rem 4rem', borderBottom: '1px solid rgba(0,0,0,0.05)' }}>
                            <div className="project-post-layout-grid">
                                <div className="project-article-card fade-in-up hover:scale-105 transition-transform duration-300" style={{ borderRadius: '16px' }}>
                                        <div className="project-hero-container">
                                         ...
                                         {PROJECT_IMAGES[projectId] && (
                                            ...
                                            <div className="comments-section mt-12 pt-12 border-t border-gray-200 dark:border-gray-700">
                                            <h4 className="text-xl font-bold mb-6 text-slate-800 dark:text-slate-100">Bình luận ({comments.length})</h4>
